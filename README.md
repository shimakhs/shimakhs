...
AI & Computer Vision Engineer with a biomedical background. I build ML/DL solutions for medical imaging and real-world applications. Experience in MS diagnosis using multi-center clinical datasets (Germany, USA, Middle East) and real-time industrial computer vision systems.
...
| **Systems & Embedded Systems** |  Linux, Raspberry Pi |
